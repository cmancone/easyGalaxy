...
class test_wascii(unittest.TestCase):
    ...
    def test_variable_format(self):
        ...
        utils.wascii(test_array, output_mock,
                     ['%1d', '%5.2f', '%3.1f', '%4.2f'])
    ...
    def test_header(self):
        ...
        utils.wascii(test_array,
                     output_mock,
                     '%5.2f',
                     header='12345 12345 12345 12345')
    ...
    def test_header_list(self):
        ...
        utils.wascii(
            ...
            output_mock,
            '%5.2f',
            header=['12345 12345 12345 12345', '67890 67890 67890 67890'])
    ...
    def test_invalid_format(self):
        ...
        with self.assertRaises(NameError):
            utils.wascii(
                np.asarray([1, 2, 3, 4]), output_mock, ['%d', '%d', '%d'])
