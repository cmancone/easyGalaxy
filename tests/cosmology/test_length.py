...
class test_lengths(unittest.TestCase):
	...
	def test_Dc_meters( self ):
		...
		self.assertAlmostEqual( self.cosmo.Dc( 1, meter=True )/1e26, 1.03107037, 7 )
	...
	def test_Dm_meters( self ):
		...
		self.assertAlmostEqual( self.cosmo.Dm( 1, meter=True )/1e26, 1.03107037, 7 )
	...
	def test_Da_meters( self ):
		...
		self.assertAlmostEqual( self.cosmo.Da( 1, meter=True )/1e25, 5.1553519, 7 )
	...
	def test_Da2_cm( self ):
		...
		self.assertAlmostEqual( self.cosmo.Da2( 1, 1.5, cm=True )/1e27, 1.3490114, 7 )
	
	def test_Da2_meters( self ):
		
		self.assertAlmostEqual( self.cosmo.Da2( 1, 1.5, meter=True )/1e25, 1.3490114, 7 )
	
	def test_Da2_pc( self ):
		
		self.assertAlmostEqual( self.cosmo.Da2( 1, 1.5, pc=True )/1e8, 4.3718491, 7 )
	
	def test_Da2_kpc( self ):
		
		self.assertAlmostEqual( self.cosmo.Da2( 1, 1.5, kpc=True )/1e5, 4.3718491, 7 )
	
	def test_Da2_mpc( self ):
		
		self.assertAlmostEqual( self.cosmo.Da2( 1, 1.5, mpc=True )/1e2, 4.3718491, 7 )
	...
	def test_Dl_meters( self ):
		...
		self.assertAlmostEqual( self.cosmo.Dl( 1, meter=True )/1e26, 2.0621407, 7 )
	...
	def test_scale_cm( self ):
		...
		self.assertAlmostEqual( self.cosmo.scale( 1, cm=True )/1e22, 2.4993851, 7 )
	
	def test_scale_meters( self ):
		
		self.assertAlmostEqual( self.cosmo.scale( 1, meter=True )/1e20, 2.4993851, 7 )
	
	def test_scale_pc( self ):
		
		self.assertAlmostEqual( self.cosmo.scale( 1, pc=True )/1e3, 8.0999570, 7 )
	...
	def test_scale_mpc( self ):
		...
		self.assertAlmostEqual( self.cosmo.scale( 1, mpc=True )*1e3, 8.0999570, 7 )
	...
	def test_lengthConversion_pc( self ):
		...
		self.assertAlmostEqual( self.cosmo.lengthConversion( pc=True )*1e17, 3.2407799, 7 )
	
	def test_lengthConversion_kpc( self ):
		
		self.assertAlmostEqual( self.cosmo.lengthConversion( kpc=True )*1e20, 3.2407799, 7 )
	
	def test_lengthConversion_mpc( self ):
		
		self.assertAlmostEqual( self.cosmo.lengthConversion( mpc=True )*1e23, 3.2407799, 7 )
