...
class test_time(unittest.TestCase):
	...
	def test_timeConversion_yr( self ):
		...
		self.assertAlmostEqual( self.cosmo.timeConversion( yr=True )*1e8, 3.1688088, 7 )
	
	def test_timeConversion_myrs( self ):
		
		self.assertAlmostEqual( self.cosmo.timeConversion( myr=True )*1e14, 3.1688088, 7 )
	
	def test_timeConversion_gyrs( self ):
		
		self.assertAlmostEqual( self.cosmo.timeConversion( gyr=True )*1e17, 3.1688088, 7 )
